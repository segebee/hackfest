...
*/
$config['tables']['users']           = 'clientsdata';
 ...
 */
$config['site_title']                 = "Carbon Credit Network Portal";       // Site Title, example.com
$config['admin_email']                = "info@carboncreditnetwork.org"; // Admin Email, admin@example.com
